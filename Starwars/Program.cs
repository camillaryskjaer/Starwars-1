...
namespace Starwars
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DataController Data = new DataController(ref planets);
            Console.WriteLine("opgave 1:");
            foreach (var item in Data.GetPlanetsByName("M"))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 2---------------------");
            foreach (var item in Data.GetPlanetsByNameConatiningLetter("Y"))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 3---------------------");
            foreach (var item in Data.GetplanetsByNumerbsOfLetters(6,15))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 4---------------------");
            foreach (var item in Data.GetPlanetByEndLetter("e","a"))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 5---------------------");
            foreach (var item in Data.GetPlanetsByRotaionsPir(40))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 6---------------------");
            foreach (var item in Data.GetPlanetsByRotaionsRange(10,20))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 7---------------------");
            foreach (var item in Data.GetPlanetsByRotaionsPirSorted(30))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 8---------------------");
            foreach (var item in Data.GetPlanetsByRot(30,50,"ba"))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 9---------------------");
            foreach (var item in Data.GetPlanetsBySurwaterSorted(0))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 10---------------------");
            foreach (var item in Data.GetPlanetBySurfaceAre())
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 11---------------------");
            foreach (var item in Data.GetPlanetsByExtop())
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 12---------------------");
            foreach (var item in Data.GetPlanetsByUnion("a","s"))
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 13---------------------");
            foreach (var item in Data.GetPlanetsByClimant())
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 14---------------------");
            foreach (var item in Data.GetPlanetsBySwampsSorted())
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 15---------------------");
            foreach (var item in Data.GetPlanetsByWoels())
            {
                Console.WriteLine(item.Name);
            }
            Console.WriteLine("----------------opgave 16---------------------");
            foreach (var item in Data.GetPlanetsByDoubleLetters())
            {
                Console.WriteLine(item.Name);
            }
            Console.ReadKey();
        ...
        public static List<Planet> LoadData()
        {
